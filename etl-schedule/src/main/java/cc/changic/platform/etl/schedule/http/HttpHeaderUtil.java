package cc.changic.platform.etl.schedule.http;
...
public final class HttpHeaderUtil {
    ...
    /**
     * Checks to see if the transfer encoding in a specified {@link io.netty.handler.codec.http.HttpMessage} is chunked
     *
